...
<form action="/support/search" method="POST" role="search">
    {{ csrf_field() }}
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
         ...
         @foreach ($tickets as $ticket)
           ...
           <ul class="liste">
            ...
            <form action = "/support/assignement/{{ $ticket->id }}" method = "post">
            ...
            <x-primary-button class="assignement3" onclick="window.location='/support/management/{{ $ticket->id }}'">  
            <strong>
             Assigné Etat
            </strong>
            </x-primary-button>
